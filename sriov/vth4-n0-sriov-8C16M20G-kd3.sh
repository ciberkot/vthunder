#!/bin/bash -x
 ...
 #softax_pcidev="83:02.0,83:0a.0,85:02.0,85:0a.0,83:02.1,83:0a.1"
 #softax_pcidev="83:02.1,85:02.1"
 softax_pcidev="83:0a.2,85:0a.2"
...
#         FILE=softax-sr-iov-0.img>w
         FILE=/home/libvirt-qemu/images/ACOS_vThunder_4_1_4-GR1-P1_78.qcow2-4
         ...
         # console output redirected to /root/softax_images/logs/${NAME}_${date}.log
                ...
                numactl --physcpubind=9-17 --membind=0 /usr/bin/qemu-system-x86_64 -enable-kvm \
                -name $NAME -M pc -daemonize --enable-kvm -cpu host -smp 9 -m 16G  \
