...
#         FILE=softax-sr-iov-0.img>w
         FILE=/home/libvirt-qemu/images/ACOS_vThunder_4_1_4-GR1-P1_78.qcow22
         ...
         # console output redirected to /root/softax_images/logs/${NAME}_${date}.log
                ...
                numactl --physcpubind=18-29 --membind=1 /usr/bin/qemu-system-x86_64 -enable-kvm \
                -name $NAME -M pc -daemonize --enable-kvm -cpu host -smp 12 -m 16G  \
