#!/bin/bash -x
 ...
 softax_pcidev="83:02.3,83:0a.3,85:02.3,85:0a.3"
...
#         FILE=softax-sr-iov-0.img>w
         ...
         # console output redirected to /root/softax_images/logs/${NAME}_${date}.log
                ...
                numactl --physcpubind=2-17 --membind=0 /usr/bin/qemu-system-x86_64 -enable-kvm \
                -name $NAME -M pc -daemonize --enable-kvm -cpu host -smp 16 -m 16G  \
