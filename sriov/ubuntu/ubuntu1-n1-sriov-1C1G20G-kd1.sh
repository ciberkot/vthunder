...
#         FILE=softax-sr-iov-0.img>w
         FILE=/home/libvirt-qemu/images/Ubuntu-CLIENT-SERVER-1.qcow2
         ...
         # console output redirected to /root/softax_images/logs/${NAME}_${date}.log
                ...
                numactl --membind=1 /usr/bin/qemu-system-x86_64 -enable-kvm \
                -name $NAME -M pc -daemonize --enable-kvm -cpu host -smp 1 -m 1G  \
