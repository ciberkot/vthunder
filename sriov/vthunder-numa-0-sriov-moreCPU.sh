...
-name vth-107-numa-0 -M pc -daemonize --enable-kvm -cpu host -smp 16 -m 16G  \
...
-drive file=/home/libvirt-qemu/images/vth-107-numa-0-sriov.qcow2,if=virtio,format=qcow2,index=0,media=disk
