#!/bin/bash -x
 ...
 #softax_pcidev="83:02.3,83:0a.3,85:02.3,85:0a.3,83:02.2,83:0a.2"
 #softax_pcidev="83:02.3,83:0a.3"
 softax_pcidev="83:0a.3,85:0a.3"
...
#         FILE=softax-sr-iov-0.img>w
         FILE=/home/libvirt-qemu/images/ACOS_vThunder_4_1_4-GR1-P1_78.qcow2
         ...
         # console output redirected to /root/softax_images/logs/${NAME}_${date}.log
                ...
                numactl --physcpubind=27-35 --membind=1 /usr/bin/qemu-system-x86_64 -enable-kvm \
