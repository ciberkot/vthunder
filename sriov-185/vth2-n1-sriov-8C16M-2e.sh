#!/bin/bash -x
 ...
 #softax_pcidev="82:02.1,82:0a.1,81:02.1,81:0a.1,82:02.0,82:0a.0"
 #softax_pcidev="82:02.1,81:02.1"
...
#         FILE=softax-sr-iov-0.img
         FILE=/home/corpse/qemu-images/vth-107-numa-1-sriov.qcow2
         ...
         # console output redirected to /root/softax_images/logs/${NAME}_${date}.log
                ...
                numactl --physcpubind=18-26 --membind=1 /usr/libexec/qemu-kvm -enable-kvm \
