#!/bin/bash -x
 ...
 softax_pcidev="82:02.1,82:0a.1,81:02.1,81:0a.1"
 #softax_pcidev="82:02.1,82:0a.1"
...
#         FILE=softax-sr-iov-0.img
         FILE=/home/corpse/qemu-images/vth-numa1-vrrp-sriov.qcow2
         ...
         # console output redirected to /root/softax_images/logs/${NAME}_${date}.log
                ...
                numactl --physcpubind=20-27,42-49 --membind=1 /usr/libexec/qemu-kvm -enable-kvm \
                -name $NAME -M pc -daemonize -cpu host -smp 16 -m 16G  \
