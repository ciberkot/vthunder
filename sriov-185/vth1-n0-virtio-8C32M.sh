#!/bin/bash -x
 ...
 softax_pcidev="82:02.3,82:0a.3,81:02.3,81:0a.3"
...
#         FILE=softax-sr-iov-0.img
         FILE=/home/corpse/qemu-images/vth-185-numa-0.qcow2
         ...
         # console output redirected to /root/softax_images/logs/${NAME}_${date}.log
                ...
                numactl --physcpubind=2-13 --membind=0 /usr/libexec/qemu-kvm  -enable-kvm \
                -name $NAME -M pc -daemonize --enable-kvm -cpu host -smp 8 -m 32G  \
	        ...
	        -netdev tap,id=net1,ifname=n1 \
        	-device virtio-net-pci,netdev=net1,mac=52:54:00:00:00:02 \
        	-netdev tap,id=net2,ifname=n2 \
