#!/bin/bash -x
 ...
 softax_pcidev="82:02.3,82:0a.3,83:02.0,83:0a.0"
...
#         FILE=softax-sr-iov-0.img
         ...
         # console output redirected to /root/softax_images/logs/${NAME}_${date}.log
                ...
                numactl --physcpubind=51-54 --membind=1 /usr/libexec/qemu-kvm  -enable-kvm \
                -name $NAME -M pc -daemonize --enable-kvm -cpu host -smp 4 -m 8G  \
